(function () {
    'use strict';
    angular.module('Siemens.Mom.Presales.Training.TrainingApp.Team').config(ViewScreenStateConfig);

    ViewScreenController.$inject = ['Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.service', '$state', '$stateParams', 'common.base', '$filter', '$scope'];
