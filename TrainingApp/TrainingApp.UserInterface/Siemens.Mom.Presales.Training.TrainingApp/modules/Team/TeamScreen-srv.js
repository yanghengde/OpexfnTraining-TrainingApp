(function () {
    'use strict';
    angular.module('Siemens.Mom.Presales.Training.TrainingApp.Team')
        .constant('Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.constants', ScreenServiceConstants())
        .service('Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.service', ScreenService)
    ...
    function ScreenServiceConstants() {
        return {
            data: {
                //appName: 'TrainingApp',
                appName: 'TrainingApp', // The name of App: in case of extended app, it is the name of AppBase
    ...
    ScreenService.$inject = ['$q', '$state', 'common.base', 'Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.constants', 'common.services.logger.service'];
    function ScreenService($q, $state, base, context, loggerService) {
        ...
        activate();
        function activate() {
            logger = loggerService.getModuleLogger('Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.service');
        ...
        function createEntity(data) {
            ...
            var obj = {
                'Team':{'Name':data.Name,'Description':data.Description,'Number':data.Number},'IsActive':data.IsActive
            };
        ...
        function updateEntity(data) {
            // TODO: Customize the mapping between "UI entity" and the "DB entity" that will create
            var obj = {
                'Id': data.Id, 'Team':{'Name':data.Name,'Description':data.Description,'Number':data.Number},'IsActive':data.IsActive
            };
    ...
    ScreenServiceRun.$inject = ['Siemens.Mom.Presales.Training.TrainingApp.Team.TeamScreen.constants', 'common.base'];
